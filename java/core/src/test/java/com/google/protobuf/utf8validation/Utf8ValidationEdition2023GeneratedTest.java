...
public class Utf8ValidationEdition2023GeneratedTest {
  // edition: 2023
  // regular field
  // validates: yes
  @Test
  public void testUnsetUnset_validates() throws Exception {
    ...
    assertThrows(
        ...
        () -> Utf8TestEditions2023.parseFrom(serialized, ExtensionRegistryLite.getEmptyRegistry()));
  }
  ...
  public void testUnsetUnsetExt_validates() throws Exception {
    ...
    registry.add(Utf8TestEditions2023Proto.extUnsetUnset);
    ...
    assertThrows(
        InvalidProtocolBufferException.class,
        () -> Utf8TestEditions2023.parseFrom(serialized, registry));
  }
  ...
  public void testUnsetDefaultExt_validates() throws Exception {
    ExtensionRegistryLite registry = ExtensionRegistryLite.newInstance();
    registry.add(Utf8TestEditions2023Proto.extUnsetDefault);
  ...
  public void testUnsetVerifyExt_validates() throws Exception {
    ExtensionRegistryLite registry = ExtensionRegistryLite.newInstance();
    registry.add(Utf8TestEditions2023Proto.extUnsetVerify);
  ...
  public void testVerifyUnsetExt_validates() throws Exception {
    ExtensionRegistryLite registry = ExtensionRegistryLite.newInstance();
    registry.add(Utf8TestEditions2023Proto.extVerifyUnset);
  ...
  public void testVerifyDefaultExt_validates() throws Exception {
    ExtensionRegistryLite registry = ExtensionRegistryLite.newInstance();
    registry.add(Utf8TestEditions2023Proto.extVerifyDefault);
  ...
  public void testVerifyVerifyExt_validates() throws Exception {
    ExtensionRegistryLite registry = ExtensionRegistryLite.newInstance();
    registry.add(Utf8TestEditions2023Proto.extVerifyVerify);
  ...
  public void testNoneUnsetExt_doesNotValidate() throws Exception {
    ExtensionRegistryLite registry = ExtensionRegistryLite.newInstance();
    registry.add(Utf8TestEditions2023Proto.extNoneUnset);
    ...
    Utf8TestEditions2023 msg = Utf8TestEditions2023.parseFrom(serialized, registry);
    assertThat(msg.hasExtension(Utf8TestEditions2023Proto.extNoneUnset)).isTrue();
    assertThat(msg.getExtension(Utf8TestEditions2023Proto.extNoneUnset)).isEqualTo("\uFFFD\uFFFD");
  }
  ...
  public void testNoneDefaultExt_doesNotValidate() throws Exception {
    ExtensionRegistryLite registry = ExtensionRegistryLite.newInstance();
    registry.add(Utf8TestEditions2023Proto.extNoneDefault);
    ...
    Utf8TestEditions2023 msg = Utf8TestEditions2023.parseFrom(serialized, registry);
    assertThat(msg.hasExtension(Utf8TestEditions2023Proto.extNoneDefault)).isTrue();
    assertThat(msg.getExtension(Utf8TestEditions2023Proto.extNoneDefault))
        .isEqualTo("\uFFFD\uFFFD");
  }
  ...
  public void testNoneVerifyExt_validates() throws Exception {
    ExtensionRegistryLite registry = ExtensionRegistryLite.newInstance();
    registry.add(Utf8TestEditions2023Proto.extNoneVerify);
