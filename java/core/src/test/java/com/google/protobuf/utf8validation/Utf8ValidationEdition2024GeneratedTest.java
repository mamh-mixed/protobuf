...
public class Utf8ValidationEdition2024GeneratedTest {
  // edition: 2024
  // regular field
  // validates: yes
  @Test
  public void testUnsetUnset_validates() throws Exception {
    ...
    assertThrows(
        ...
        () -> Utf8TestEditions2024.parseFrom(serialized, ExtensionRegistryLite.getEmptyRegistry()));
  }
  ...
  public void testNoneUnset_doesNotValidate() throws Exception {
    ...
    Utf8TestEditions2024 msg =
        Utf8TestEditions2024.parseFrom(serialized, ExtensionRegistryLite.getEmptyRegistry());
    assertThat(msg.hasNoneUnset()).isTrue();
    assertThat(msg.getNoneUnset()).isEqualTo("\uFFFD\uFFFD");
  }
  ...
  public void testNoneDefault_doesNotValidate() throws Exception {
    ...
    Utf8TestEditions2024 msg =
        Utf8TestEditions2024.parseFrom(serialized, ExtensionRegistryLite.getEmptyRegistry());
    assertThat(msg.hasNoneDefault()).isTrue();
    assertThat(msg.getNoneDefault()).isEqualTo("\uFFFD\uFFFD");
  }
  ...
  public void testUnsetUnsetExt_validates() throws Exception {
    ...
    registry.add(Utf8TestEditions2024Proto.extUnsetUnset);
    ...
    assertThrows(
        InvalidProtocolBufferException.class,
        () -> Utf8TestEditions2024.parseFrom(serialized, registry));
  }
  ...
  public void testUnsetDefaultExt_validates() throws Exception {
    ExtensionRegistryLite registry = ExtensionRegistryLite.newInstance();
    registry.add(Utf8TestEditions2024Proto.extUnsetDefault);
  ...
  public void testUnsetVerifyExt_validates() throws Exception {
    ExtensionRegistryLite registry = ExtensionRegistryLite.newInstance();
    registry.add(Utf8TestEditions2024Proto.extUnsetVerify);
  ...
  public void testVerifyUnsetExt_validates() throws Exception {
    ExtensionRegistryLite registry = ExtensionRegistryLite.newInstance();
    registry.add(Utf8TestEditions2024Proto.extVerifyUnset);
  ...
  public void testVerifyDefaultExt_validates() throws Exception {
    ExtensionRegistryLite registry = ExtensionRegistryLite.newInstance();
    registry.add(Utf8TestEditions2024Proto.extVerifyDefault);
  ...
  public void testVerifyVerifyExt_validates() throws Exception {
    ExtensionRegistryLite registry = ExtensionRegistryLite.newInstance();
    registry.add(Utf8TestEditions2024Proto.extVerifyVerify);
  ...
  public void testNoneUnsetExt_doesNotValidate() throws Exception {
    ExtensionRegistryLite registry = ExtensionRegistryLite.newInstance();
    registry.add(Utf8TestEditions2024Proto.extNoneUnset);
    ...
    Utf8TestEditions2024 msg = Utf8TestEditions2024.parseFrom(serialized, registry);
    assertThat(msg.hasExtension(Utf8TestEditions2024Proto.extNoneUnset)).isTrue();
    assertThat(msg.getExtension(Utf8TestEditions2024Proto.extNoneUnset)).isEqualTo("\uFFFD\uFFFD");
  }
  ...
  public void testNoneDefaultExt_doesNotValidate() throws Exception {
    ExtensionRegistryLite registry = ExtensionRegistryLite.newInstance();
    registry.add(Utf8TestEditions2024Proto.extNoneDefault);
    ...
    Utf8TestEditions2024 msg = Utf8TestEditions2024.parseFrom(serialized, registry);
    assertThat(msg.hasExtension(Utf8TestEditions2024Proto.extNoneDefault)).isTrue();
    assertThat(msg.getExtension(Utf8TestEditions2024Proto.extNoneDefault))
        .isEqualTo("\uFFFD\uFFFD");
  }
  ...
  public void testNoneVerifyExt_validates() throws Exception {
    ExtensionRegistryLite registry = ExtensionRegistryLite.newInstance();
    registry.add(Utf8TestEditions2024Proto.extNoneVerify);
