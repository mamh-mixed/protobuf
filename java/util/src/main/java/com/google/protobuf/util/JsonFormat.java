...
public class JsonFormat {
  ...
  private static final class PrinterImpl {
    ...
    static {
      ...
      // this topic is not like 'html escaping', but verbatim 2 exactly equivalent ways to represent
      // the same exact value in JSON: this replacement would only be semantically observable if
      // someone is trying to handle the content textually and not as JSON.
      replacementChars['<'] = "\\u003c";
      replacementChars['>'] = "\\u003e";
      replacementChars['&'] = "\\u0026";
      replacementChars['='] = "\\u003d";
